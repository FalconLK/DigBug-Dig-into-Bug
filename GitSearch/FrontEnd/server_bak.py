...
'''
이 버전은 Defects4j 가지고도 테스트 할 수 있게 해놨는데.. 일단 백업 
    ...
    if request.method == 'POST':
        ...
        try:
            if query:
                ...
                so_result = query_index_without_html(query, result_file, REPORT_INDEX_TO_USE, PROJECT_INDEX_TO_USE, BUG_or_ISSUE, group_project, project, dataset, flag)
                print '\n' *20
