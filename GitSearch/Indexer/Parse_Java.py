...
def index_code_snippet(writer):
    ...
    print
    "Number of duplicates: %s" % len(hashes)
...
if __name__ == '__main__':
    # main()
    jfile = '/extdsk/iFixR/data/gitrepo_old/hive/ql/src/java/org/apache/hadoop/hive/ql/ddl/view/CreateViewOperation.java'
    with codecs.open(jfile, "r", encoding='utf-8') as f:
        file_content = f.read().encode("utf-8")
    ast = parse(file_content, resolve=False)
    print(ast["typed_method_call"])