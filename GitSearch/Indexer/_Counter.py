class Counter:
    ...
    def __str__(self):
        return str(self.typed_method_call_count) + " / " + str(self.extends_count) + " / " + str(self.used_classes_count) + " / " + str(self.methods_count) + " / " + str(self.methods_called_count) + " / " + str(self.class_instance_creation_count) + " / " + str(self.code_hints_count) + " / " + str(self.unresolved_method_calls_count) + " / "
