import os
from utils import md5, so_tokenizer, copytree, mkdir_p, cleanMetaPath, write_file_a, read_file
...
git_repo_path = 'path'
for dir in os.listdir(git_repo_path):
